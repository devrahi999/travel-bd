...
class _BusinessProfileScreenState extends State<BusinessProfileScreen> {
  // Business fields
  final _ownerName = 'কাজী মারুফ';
  final _bizName = 'Long Beach Hotel';
  final _email = 'maruf@longbeachhotel.com.bd';
  final _phone = '01712345678';
  final _tin = '123456789012';
          ...
          children: [
            ...
            _buildMenuCard([
              _buildMenuItem(
                ...
                subtitle: 'নাম, ফোন, ইমেইল এবং টিআইএন',
        ...
        child: Column(
          ...
          children: [
            ...
            AppButton(
              ...
              onPressed: () {
                setState(() {
                  _bankName = bankNameCtrl.text;
                  _accNum = accNumCtrl.text;
                  _bkashNum = bkashNumCtrl.text;
                });
                Navigator.pop(context);
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
