    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _SwitchTile(label: isEnglish ? 'Email Notifications' : 'ইমেইল নোটিফিকেশন', icon: Icons.email_rounded, value: _emailNotifications, onChanged: (v) => setState(() => _emailNotifications = v)),
          ...
          _ActionTile(label: isEnglish ? 'Change Password' : 'পাসওয়ার্ড পরিবর্তন', icon: Icons.lock_outline_rounded, onTap: () {}),
