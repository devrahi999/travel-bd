...
class _HotelDetailScreenState extends ConsumerState<HotelDetailScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // Glass book now bar
      bottomNavigationBar: GlassTheme.glassContainer(
        blurSigma: 14,
        opacity: 0.12,
        borderRadius: 0,
        border: Border(
          ...
          children: [
            Expanded(
              child: Column(
                ...
                children: [
                  Text(tr('detail_starts_at'), style: AppTextStyles.labelSm.copyWith(color: AppColors.onSurfaceVariant.withValues(alpha: 0.7))),
                  Text('৳3,500${tr('detail_per_night')}', style: AppTextStyles.headlineSm.copyWith(color: AppColors.primary)),
                ],
              ),
            ),
